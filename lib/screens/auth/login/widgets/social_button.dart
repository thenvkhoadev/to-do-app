...
class SocialButton extends StatelessWidget {
  ...
  final String type; // 'google', 'github', 'facebook', 'meta'
  ...
  Widget _getIcon() {
    switch (type.toLowerCase()) {
      ...
      case 'facebook':
      case 'meta':
        return SvgPicture.string(_facebookSvg, width: 20, height: 20);
      case 'github':
        return SvgPicture.string(
          _githubSvg,
          width: 20,
          height: 20,
          colorFilter: const ColorFilter.mode(LoginColors.onSurface, BlendMode.srcIn),
        );
      default:
