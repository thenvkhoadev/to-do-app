    ...
    return AnimatedHoverCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Output density by work category',
            style: TextStyle(
          ...
          for (final item in AnalyticsMockData.velocity) ...[
            ...
            if (item != AnalyticsMockData.velocity.last)
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: DashboardColors.primary.withValues(alpha: .06),
            ...
            child: const Text(
              'Design Systems has the highest velocity. Protect this category during morning sprint windows.',
              style: TextStyle(
                color: DashboardColors.onSurfaceVariant,
                height: 1.45,
                fontSize: 12,
