          ...
          children: [
            Positioned.fill(
              child: GestureDetector(
                onTap: onClose,
                child: Container(color: Colors.black.withValues(alpha: .14)),
              ),
            ),
            AnimatedPositioned(
              ...
              child: AnimatedAlign(
                ...
                curve: Curves.easeOutCubic,
                alignment:
                    visible ? Alignment.bottomLeft : Alignment.bottomCenter,
      ...
      children: [
        const Expanded(
          child: Wrap(
            spacing: 8,
            runSpacing: 8,
            children: [PriorityBadge(), StatusBadge()],
          ),
        ),
        Material(
...
class PriorityBadge extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => _PillBadge(
    label: 'HIGH PRIORITY',
...
class StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _PillBadge(
    ...
    background: DashboardColors.primaryContainer,
  );
}
...
class SuggestedSubtasksSection extends StatefulWidget {
  ...
  @override
  State<SuggestedSubtasksSection> createState() =>
      _SuggestedSubtasksSectionState();
}

class _SuggestedSubtasksSectionState extends State<SuggestedSubtasksSection> {
  final checked = <bool>[true, false, false];
  final subtasks = const [
    'Audit elevation blur tokens',
    'Normalize rounded corner scale',
    'Verify contrast on glass cards',
  ];
  ...
  Widget build(BuildContext context) {
    return _SectionShell(
      ...
      trailing: 'Calculated by NEXUS AI',
      child: Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: DashboardColors.surfaceLow.withValues(alpha: .40),
        ...
        child: Column(
          children: List.generate(
            ...
            (index) => _SubtaskRow(
              ...
              onTap: () => setState(() => checked[index] = !checked[index]),
            ),
          ),
        ),
      ),
              ...
              decoration: BoxDecoration(
                color:
                    checked
                        ...
                        : Colors.transparent,
                borderRadius: BorderRadius.circular(checked ? 8 : 4),
                border: Border.all(
                  color:
                      checked
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  color:
                      checked
                          ? DashboardColors.onSurface.withValues(alpha: .60)
                          : DashboardColors.onSurfaceVariant,
                  fontSize: 16,
                  decoration: checked ? TextDecoration.lineThrough : null,
                  decorationColor: DashboardColors.onSurface,
                ),
              ),
            ),
          ],
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const Text(
                  'Optimize elevation tokens in the Style Guide',
                  style: TextStyle(
                    color: DashboardColors.primary,
                    fontSize: 12,
                    fontWeight: FontWeight.w800,
