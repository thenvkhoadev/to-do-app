...
class SettingsMobileBottomNavigation extends StatelessWidget {
  const SettingsMobileBottomNavigation({required this.bottomInset, super.key});
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              _BottomNavItem(icon: Icons.settings_rounded, label: 'Settings', active: true, onTap: () => context.go('/settings')),
            ],
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        ...
        onTap: onTap,
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: active ? 12 : 7, vertical: 7),
