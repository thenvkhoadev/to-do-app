    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: columns, crossAxisSpacing: DashboardSpacing.md, mainAxisSpacing: DashboardSpacing.md, childAspectRatio: columns == 1 ? 2.4 : (columns == 2 ? 1.55 : 1.05)),
          itemBuilder: (context, index) => SupportCategoryCard(category: SupportMockData.categories[index]),
        );
      },
    );
  }
